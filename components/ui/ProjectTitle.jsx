...
export default function ProjectTitle({ href, children, handle, remove, mobile, show }) {
  return (
    <>
      ...
      {mobile && <span
        onClick={handle}
        className="z-10 cursor-pointer hover:after:bg-black flex items-start gap-2 group after:transition-colors after:duration-300  after:block after:absolute relative after:bottom-0.6 after:w-full after:h-0.5 after:bg-transparent   "
      >
        <h1>{children}</h1>
        <Image
          alt="arrow"

...
export default function Anchor({ href, children, style }) {
  return (
    ...
    >
      <span className={`relative after:absolute after:bottom-0.5 after:left-0.5 after:right-0 after:w-auto after:h-[1px] group-hover:after:bg-transparent after:bg-black inline-block ${style}`}>
        {children}
      </span>
      <Image
